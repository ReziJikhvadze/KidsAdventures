...
public static class FastPreviewPlan
{
    ...
    {
        "clouds" => ["ღრუბლების ქალაქის დაკარგული რუკა", "თვითმფრინავის დაკარგული პროპელერი", "პატარა ღრუბლის ლეკვი, ფუმფულა", "ღრუბლების ქალაქის ჯადოსნური ჩიტი", "მოწყენილი ღრუბელი"],
        "space" => ["ასტრონავტის დაკარგული ჩაფხუტი", "მთვარეზე ნაპოვნი კოსმოსური ხომალდი", "ფერადი პლანეტები და ტელესკოპი", "მთვარეზე ნაპოვნი ჩაკრულოს ჩანაწერი", "ციდან ჩამოვარდნილი მეტეორიტი"],
        "forest" => ["ბუს დაკარგული საათი", "ტყის ბილიკზე ნაპოვნი კვერცხი", "მომღერალი ბულბული", "ხიდან ჩამოვარდნილი ჩიტის ბუდე", "დაკარგული დათვის ბელი"],
        "ocean" => ["ნიჟარაში დამალული რუკა", "მოწყენილი მეკობრე", "ბოთლში ჩადებული საიდუმლო წერილი", "ქვიშაში ჩამალული განძი", "ოქროს თევზების ყურე"],
        "magic" => ["სინათლის ქალაქის ჩამქრალი ფარანი", "ჯადოსნური ჯოხი", "მუსიკალური ყუთი", "მხატვრის დაკარგული ფუნჯი", "ჯადოსნური სასახლის ვარსკვლავი"],
        "dinosaurs" => ["დინოზავრის ფერადი კვერცხი", "პატარა მოწყენილი დინოზავრი", "კეთილი დინოზავრების ხეობა", "დინოზავრის ნაკვალევი", "დინოზავრების მეგობრობის ზეიმი"],
