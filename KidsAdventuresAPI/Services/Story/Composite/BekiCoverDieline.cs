...
public static class BekiCoverDieline
{
    ...
    public const string PanelInstructions =
        ...
        + "Front Beki integration zone: a naturally lit, visually quiet area centred at about "
        + "80% of the canvas width and 62% of the canvas height, roughly one third of the canvas "
        + "height tall. Keep it free of characters, faces, hands, hard foreground edges, and "
