...
public static class BekiImageQaPrompt
{
    ...
    public static string For(string scene, string textSide, string characterLock) =>
        $$"""
        ...
        3. recurring characters remain recognizable and consistent,
    ...
    private static string TextSideRule(string textSide)
    {
        ...
        return side is "left" or "right"
            ? $"The {side} third of this image was reserved for story text printed over it: that "
              ...
              + "character, face, hands or main action inside it. Faces and the key action were "
