...
public static class MasterStoryPrompt
{
    ...
    public static string System(MasterStoryInput input)
    {
        ...
        return $"""
            ...
            ## როგორ დაწერო — შესასრულებელი წესები

            ეს არ არის განწყობის აღწერა. ეს ექვსი წესი შესრულებადია და შესამოწმებელი.

            **1. რეფრენი.** მოიგონე ერთი მოკლე ფრაზა — 2–5 სიტყვა — და გაიმეორე
            **სიტყვასიტყვით მინიმუმ სამ სცენაზე**. სწორედ ეს ფრაზა რჩება ბავშვს ყურში და
            სწორედ მას იმეორებს ხმამაღლა, სანამ კითხულობ.

            **2. აჩვენე, არა მოყევი.** არ დაწერო რა მოხდა — დაწერე ისე, თითქოს ხედავ.
            ცუდი: „გიო შეწუხდა და დაეხმარა.“
            კარგი: „გიომ სუნთქვა შეიკრა. მერე ფრთხილად, ორივე ხელით, ტოტი ასწია.“

            **3. ხმა და შეხება, არა მარტო თვალი.** სცენების უმეტესობაში იყოს რაღაც, რაც
            **ისმის, ეხება ან ყნოსავს** — ხმაური, სიცივე, სუნი, ხაოიანი ქერქი. მარტო
            ნანახი სამყარო ბრტყელია.

            **4. გმირს საკუთარი ხმა აქვს.** მინიმუმ სამ სცენაზე გიო ან ლაპარაკობს, ან
            ფიქრობს თავის სიტყვებით. ბავშვს გმირი მაშინ უყვარდება, როცა ესმის.

            **5. რიტმი წინადადების სიგრძით იქმნება.** ყოველ გვერდზე ერთი წინადადება იყოს
            **ძალიან მოკლე** — 2–4 სიტყვა. სამი ერთნაირი სიგრძის წინადადება ზედიზედ
            ჩამონათვალად ჟღერს, არა ზღაპრად.

            **6. ერთი მოულოდნელობა.** სადმე მოხდეს რაღაც პატარა და გაუთვალისწინებელი,
            რაც სიუჟეტს არ ტეხს — ისეთი, რაზეც ბავშვი გაიცინებს ან თვალებს გაახელს.

            დანარჩენი ისედაც იგულისხმება: მარტივი ენა, თბილი ურთიერთობები, ჯადოსნური
            ელემენტები და სამყარო ბავშვის თვალით.
            ...
            **არ დაწერო** სტილი, ფორმატი, ფოტოს შესახებ ინსტრუქცია და პერსონაჟების მუდმივი
            ...
            - მეორდება თუ არა რეფრენი სიტყვასიტყვით მინიმუმ სამ სცენაზე;
            - აქვს თუ არა ყოველ გვერდს ერთი ძალიან მოკლე წინადადება;
            - ლაპარაკობს ან ფიქრობს თუ არა გმირი მინიმუმ სამ სცენაზე;
            - არის თუ არა სცენებში ხმა, შეხება ან სუნი — არა მარტო ნანახი;
