    ...
    public static string System(MasterStoryInput input)
    {
        ...
        return $"""
            ...
            **8. ილუსტრატორის მომენტი.** ყოველ სცენას ჰქონდეს ერთი კადრი, რომლის დახატვაც
            ...
            ეს ხარვეზები ყველაზე ხშირად ჩნდება, და თითოეული წიგნს მოსაწყენს ხდის:

            - **ერთი და იგივე ბიტი რამდენჯერმე.** თუ სამი სცენა არის „დაბრკოლება → გმირს
              ეშინია → ერთი ნაბიჯი“, ეს ერთი სცენაა სამჯერ. ყოველი დაბრკოლება სხვა **სახის**
              უნდა იყოს: ერთი ფიზიკური, ერთი სოციალური, ერთი შინაგანი.
            - **ერთნაირად დაწყებული სცენები.** არ დაიწყო ყველა სცენა გმირის სახელით.
            - **ერთნაირად დასრულებული სცენები.**
            - **უსახელო პერსონაჟები.** თუ ვინმე ლაპარაკობს ან მოქმედებს, მას სახელი აქვს.
              „ერთმა ჩიტმა“ და „ერთმა ცხოველმა“ ისტორიას ასუსტებს.
            ...
            **არ დაწერო** სტილი, ფორმატი, ფოტოს შესახებ ინსტრუქცია და პერსონაჟების მუდმივი
            ...
            - რეფრენი მიწებებულია და არა ჩაქსოვილი;
