...
export function Contact() {
  ...
  return (
    /*
      One screen, send included, and the details beside it.
      ...
      The merchant's details used to be a second full-width card underneath, which made a page
      of two short things into a page you scroll. They are a column now: the form and who you
      are writing to, side by side, stacking back into one column where there is no room for two.
    */
    <section className="py-4 md:py-5">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        ...
        <div className="mt-4 grid items-start gap-4 lg:grid-cols-[1.08fr_0.92fr] lg:gap-5">
