/**
 * Copy for the six Beki worlds. See the Georgian catalogue for the rule these follow:
 * one world, one name, shared by `mapLabel`, `place`, `mapTitle`, `chapter` and `memoryTitle`.
 *
...
export const worlds = {
  ...
  space: {
    ...
    memoryTitle: "The Path of Stars",
    memoryBody: "Here they found the lost star and lit a new path across the map.",
  },
  pirates: {
    theme: "Pirates",
    mapLabel: "The Secret Island",
    place: "The Secret Island",
    into: "to the pirates",
  ...
  airplanes: {
    theme: "Aeroplanes",
    mapLabel: "The City of Clouds",
    place: "The City of Clouds",
    into: "beyond the clouds",
    mapTitle: "The City of Clouds",
