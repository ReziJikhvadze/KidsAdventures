...
export const journey = {
  ...
  packages: {
    ...
    print: {
      ...
      features: [
        ...
        "Tbilisi 5 days free · regions 5–7 days",
      ],
    },
  },
  ...
  checkout: {
    stepAddress: "Where should your book go?",
    copiesFewer: "One fewer",
    copiesMore: "One more",
    giftWrap: "Gift wrapping",
    giftWrapNote: "Beautifully wrapped, ready to give",
    optional: "optional",
    promoLabel: "Have a promo code?",
    promoRemove: "Remove code",
    promoApplied: "Promo code applied",
    promoInvalid: "This code does not work or has expired.",
    packageDigital: "Digital edition",
    packagePrint: "Printed book + digital edition",
    ...
    secureNote: "Secure payment on the bank's page",
    zeroTotal: "Nothing to pay",
    zeroTotalNote: "No card needed - the order activates straight away.",
    recipient: "Recipient's name",
    pickLocation: "Choose on the map",
    pickLocationTitle: "Where should the book go?",
    pickLocationHint: "Search for the street, or tap the map.",
    pickLocationSteps: "Search · drop the pin · confirm",
    pickLocationSearch: "Find the address",
    pickLocationSelected: "Selected address",
    pickLocationDrag: "Drag the pin to the exact spot.",
    ...
    requiredRecipient: "Tell us who will receive the book.",
    ...
    editAddress: "Change",
    editingAddress: "Change address",
    saveAddress: "Save",
    cancelEdit: "Cancel",
    saveAddressFailed: "The address could not be saved. Try again.",
    beki: {
      whereTo: "Almost there! Tell me where the book should go.",
    ...
    deliveryName: {
      TbilisiExpress: "Express delivery",
      TbilisiStandard: "Standard delivery",
  ...
  generated: {
    ...
    deliveryNote:
      "Your printed book will arrive at the address you gave - in Tbilisi 5 days free or 3 days for 7 GEL, elsewhere in Georgia 5–7 days for 8 GEL.",
    pageBadge: " 16 pages",
