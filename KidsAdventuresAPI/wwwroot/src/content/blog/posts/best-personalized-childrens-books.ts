...
export const bestPersonalizedChildrensBooks: BlogPost = {
  ...
  sections: [
    ...
    {
      heading: "Illustrations that look like your child",
      paragraphs: [
        "Photo upload features that create a cartoon hero across every page feel magical to kids. It is a step beyond classic name books and works great for birthdays, holidays, and grandparent gifts.",
      ],
    },
    {
