...
export const parentingBedtimeReading: BlogPost = {
  ...
  sections: [
    ...
    {
      heading: "Read-aloud tips for tired parents",
      paragraphs: [
        "You do not need character voices. Point at illustrations, pause for predictions, and let your child fill in their name when it appears. Short chapters from a 6-page book fit even on busy weeknights.",
      ],
    },
    {
